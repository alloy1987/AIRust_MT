...
import { skipPreviewSourceBackward, skipPreviewSourceForward } from './block/previewSource';
...
export class Muya {
    ...
    deleteParagraph() {
        ...
        if (block.prev) {
            // A caret placed inside an html / math / diagram block flips it
            // to its raw-source view, so skip past such blocks instead of
            // dropping the caret into one after the deletion.
