  ...
  <div class="dialog-mask" @click.self="emit('cancel')">
    <div class="dialog" role="dialog" aria-modal="true">
      ...
      <div class="dialog-actions">
        <button class="btn primary" @click="emit('save')">{{ t('saveAndClose') }}</button>
        <button class="btn danger" @click="emit('discard')">{{ t('discard') }}</button>
...
.btn.danger:hover {
  ...
  border-color: var(--danger, #e81123);
  color: #fff;
}
</style>
